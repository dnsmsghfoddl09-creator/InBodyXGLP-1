    ...
    <div className="flex-1">
      <div className="border-b border-gray-100 bg-white px-4 py-6 lg:px-8 lg:py-8">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-gray-500 lg:text-base">
          Obesity, GLP-1, and body composition research with evidence grading, clinical implications,
          and InBody business intelligence summaries.
        </p>
      </div>

      <div className="px-4 py-6 lg:px-8 lg:py-8">
        <ResearchIntelligenceModule variant="center" />
      </div>
    </div>
  );
}
